    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "SexyBoyfriendAI uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'd4407e3d-ba8f-4f7c-8d07-360ba452b357',
                    name: data.name || '',
                    email: data.email || '',
